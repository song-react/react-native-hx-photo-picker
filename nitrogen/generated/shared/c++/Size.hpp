...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::hxphotopicker::Size> final {
    static inline margelo::nitro::hxphotopicker::Size fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::hxphotopicker::Size(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::hxphotopicker::Size& arg) {
