...
namespace margelo::nitro::hxphotopicker {
  ...
  /**
   * A struct which can be represented as a JavaScript object (CaptureMediaResult).
   */
  struct CaptureMediaResult final {
  public:
...
namespace margelo::nitro {
  ...
  // C++ CaptureMediaResult <> JS CaptureMediaResult (object)
  template <>
  struct JSIConverter<margelo::nitro::hxphotopicker::CaptureMediaResult> final {
    static inline margelo::nitro::hxphotopicker::CaptureMediaResult fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::hxphotopicker::CaptureMediaResult(
