...
export type ModalPresentationStyleOption =
  | 'fullScreen'
  | 'pageSheet'
  | 'formSheet'
  | 'currentContext'
...
export type InterfaceOrientationOption =
  | 'portrait'
  | 'portraitUpsideDown'
  | 'landscapeLeft'
  | 'landscapeRight'
...
export type ActivityIndicatorStyleOption =
  | 'gray'
  | 'white'
  | 'large'
  | 'medium'
...
export type BlurEffectStyleOption =
  | 'extraLight'
  | 'light'
  | 'dark'
  | 'regular'
...
export type SystemCameraVideoQualityOption =
  | 'typeHigh'
  | 'typeMedium'
  | 'typeLow'
  | 'type640x480'
...
export type CameraAspectRatioOption =
  | 'fullScreen'
  | 'ratio9x16'
  | 'ratio16x9'
  | 'ratio3x4'
...
export type PhotoListSaveSystemAlbumTypeOption =
  | 'none'
  | 'displayName'
  | 'custom'
